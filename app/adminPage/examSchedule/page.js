        ...
        try {
            ...
            worksheet.eachRow({ includeEmpty: false }, (row, rowNumber) => {
                ...
                row.eachCell({ includeEmpty: true }, (cell, colNumber) => {
                    ...
                    rowData[header ? header.toString() : `Column${colNumber}`] = cell.value; // Correctly set default column name
                });
                ...
                <main className="p-8">
                    <div className="max-w-2xl mx-auto">
                        <Card className="bg-gray-800 border-gray-700">
                            <CardHeader>
                                <CardTitle className="text-2xl font-bold text-center text-gray-100">Upload Exam Schedule</CardTitle>
                            </CardHeader>
                            <CardContent>
